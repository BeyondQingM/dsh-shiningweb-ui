 ...
 */
export function buildTokenOverrides(themeColor) {
 ...
 */
export function createThemeOverrideController(theme) {
    let activeDisposer = null;
    let activeColor = null;
    return {
        apply(themeColor) {
            if (activeColor === themeColor)
                return;
            activeDisposer?.();
            activeDisposer = null;
            activeColor = null;
...
export function getThemeService(ctx) {
