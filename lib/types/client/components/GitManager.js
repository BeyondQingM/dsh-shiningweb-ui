...
import { useWorkspaceRoot } from "../workspace.js";
    ...
    useEffect(() => {
        ...
        const refresh = async () => {
            try {
                ...
                if (alive)
                    setGitErr(e instanceof Error ? `remote调用失败: ${e.message}` : String(e));
            }
        };
        void refresh();
