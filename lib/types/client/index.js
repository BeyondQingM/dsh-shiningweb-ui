...
import { bindDshCtx, getCurrentSessionId } from "./dsh-context.js";
import { resolveCurrentWorkspaceRoot, setWorkspaceRoot, setOpenPath, getWorkspaceRoot } from "./workspace.js";
...
export async function apply(ctx) {
    ...
    setOpenPath((path) => {
        ...
        if (sessionId === undefined)
            return;
        const opener = ctx.get('sidebarRight');
        if (opener === undefined)
            return;
