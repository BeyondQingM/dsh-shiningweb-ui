...
const res_fsList = z.object({ entries: z.array(z.object({ name: z.string(), isDirectory: z.boolean(), size: z.number() })) })
const req_fsRead = z.object({ root: z.string(), path: z.string() })
const res_fsRead = z.object({ content: z.string() })
const req_fsWrite = z.object({ root: z.string(), path: z.string(), content: z.string() })
const res_fsWrite = z.object({ path: z.string() })
const req_fsCreateFile = z.object({ root: z.string(), path: z.string() })
const res_fsCreateFile = z.object({ path: z.string() })
const req_fsCreateDir = z.object({ root: z.string(), path: z.string() })
const res_fsCreateDir = z.object({ path: z.string() })
const req_fsRename = z.object({ root: z.string(), path: z.string(), newName: z.string() })
const res_fsRename = z.object({ path: z.string() })
const req_fsDelete = z.object({ root: z.string(), path: z.string() })
const res_fsDelete = z.object({ path: z.string() })
const req_gitStatus = z.object({ root: z.string(), repoPath: z.string() })
const res_gitStatus = z.object({ branch: z.string(), dirtyCount: z.number(), changes: z.array(z.object({ path: z.string(), status: z.union([z.literal("M"), z.literal("A"), z.literal("D"), z.literal("U")]) })) })
const req_gitCheckout = z.object({ root: z.string(), repoPath: z.string(), branch: z.string() })
const res_gitCheckout = z.object({ output: z.string() })
const req_gitCreateBranch = z.object({ root: z.string(), repoPath: z.string(), name: z.string() })
const res_gitCreateBranch = z.object({ output: z.string() })
const req_gitPull = z.object({ root: z.string(), repoPath: z.string() })
const res_gitPull = z.object({ output: z.string() })
...
const res_chat = z.object({ content: z.string() })
const req_qqList = z.object({})
const res_qqList = z.object({ sessions: z.array(z.object({ key: z.string(), peerId: z.string(), kind: z.union([z.literal("group"), z.literal("c2c")]), messages: z.array(z.object({ role: z.union([z.literal("user"), z.literal("assistant")]), content: z.string() })), updatedAt: z.number() })) })
const req_qqRead = z.object({ key: z.string() })
const res_qqRead = z.object({ session: z.unknown().optional() })
const req_qqSend = z.object({ key: z.string(), content: z.string() })
const res_qqSend = z.object({ ok: z.boolean() })
